...
import static it.uniroma1.metodologie2018.javabomber.utils.PowerUpTextures.SPEED_DOWN;
/**
 * Rallenta il personaggio che lo raccoglie, fino ad un cap di 1/2 della velocità normale.
 *
...
//////////////////////////////COSTRUTTORE///////////////////////////
	 ...
	 */
	public SpeedDown(WorldController controller, Vector2 position) 
	{
		//Setup delle informazioni.
		super(controller, position);
		//Setup dello sprite.
		texture = new Texture(Gdx.files.internal(SPEED_DOWN));
...
////////////////////////METODI PER L'APPLICAZIONE DEL POWERUP//////////////////////////
	...
	@Override
	public void powerStats(Characters subject) 	{if(subject.getSpeed() > 0.50f)	subject.speedDown();}
}
