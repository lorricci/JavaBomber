...
import static it.uniroma1.metodologie2018.javabomber.utils.PowerUpTextures.PUSH_BOMBS;
/**
 * PowerUp che permette al giocatore o ad altri personaggi di spingere le bombe
 * in una direzione.
 * @author Lorenzo Ricci
 *
 */
public class PushBombs extends PowerUp
{
...
////////////////////////////////COSTRUTTORE//////////////////////////////
	...
	*/
	public PushBombs(WorldController controller, Vector2 position) 
	{
		//Setup delle informazioni.
		super(controller, position);
		//Setup dello sprite.
		texture = new Texture(Gdx.files.internal(PUSH_BOMBS));
...
//////////////////METODI PER L'APPLICAZIONE DEL POWERUP////////////////////////
	...
	@Override
	public void powerStats(Characters subject) {subject.enablePushBombs();}
