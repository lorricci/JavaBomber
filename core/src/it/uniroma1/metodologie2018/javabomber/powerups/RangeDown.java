...
import static it.uniroma1.metodologie2018.javabomber.utils.PowerUpTextures.RANGE_DOWN;
/**
 * Diminuisce il raggio di esplosione della bomba del personaggio che raccoglie
 * il powerUp.
 * @author Lorenzo Ricci
 *
 */
public class RangeDown extends PowerUp
{
...
///////////////////////////COSTRUTTORE/////////////////////////////////
	 ...
	 */
	public RangeDown(WorldController controller, Vector2 position) 
	{
		//Setup delle informazioni.
		super(controller, position);
		//Setup dello sprite.
		texture = new Texture(Gdx.files.internal(RANGE_DOWN));
...
///////////////////////METODI PER L'APPLICAZIONE DEL POWERUP//////////////////////
	...
	@Override
	public void powerStats(Characters subject) {subject.getBombStats().decreaseRange(32f);}
}
