...
import static it.uniroma1.metodologie2018.javabomber.utils.PowerUpTextures.MORE_BOMBS;
/**
 * Aumenta il numero di bombe piazzabili dal personaggio che lo raccoglie.
...
/////////////////////////COSTRUTTORE/////////////////////////////
	 ...
	 */
	public MoreBombs(WorldController controller, Vector2 position) 
	{
		//Setup delle informazioni.
		super(controller, position);
		//Setup dello sprite.
		texture = new Texture(Gdx.files.internal(MORE_BOMBS));
...
//////////////////////METODI PER L'APPLICAZIONE DEL POWERUP///////////////////////
	...
	{
		subject.getBombStats().maxUp();
		subject.getBombStats().addPlacing();
	}
}
