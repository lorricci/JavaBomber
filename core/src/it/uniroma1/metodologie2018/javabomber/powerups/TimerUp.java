...
import static it.uniroma1.metodologie2018.javabomber.utils.PowerUpTextures.TIMER_UP;
/**
 * Aumenta il tempo a disposizione per la conclusione del match.
 * 
 * @author Lorenzo Ricci
 */
public class TimerUp extends PowerUp
{
...
//////////////////////////COSTRUTTORE////////////////////////
	 ...
	 */
	public TimerUp(WorldController controller, Vector2 position) 
	{
		//Setup delle informazioni.
		super(controller, position);
		setGameTimer(controller);
		//Setup dello sprite.
		texture = new Texture(Gdx.files.internal(TIMER_UP));
...
///////////////////METODI PER L'APPLICAZIONE DEL POWERUP//////////////////
	...
	@Override
	public void powerStats(Characters subject) {gameTimer.addMinute();}
}
